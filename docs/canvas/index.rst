...
This code is based on the following `research paper <https://machinelearning.apple.com/research/composing-interactive-interfaces>`__:
...
| `Paper <https://arxiv.org/abs/2202.08946>`__, `Code <https://github.com/apple/ml-canvas/>`__, `Preview <https://www.youtube.com/watch?v=Wf-YRBsI-wA>`__, `Video <https://www.youtube.com/watch?v=0Q3wIh3AiPs>`__ \*Contributed equally
...
If you want to create your own component, check out our :doc:`creation` page, or explore the Canvas code at our `GitHub repo <https://github.com/betterwithdata/ml-canvas>`__. 

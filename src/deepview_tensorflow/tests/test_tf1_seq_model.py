...
from deepview.samples import StubGatedAdditionDataset
from deepview.base import pipeline, ResponseInfo, Model, Batch, PipelineStage
...
from deepview_tensorflow.samples import get_simple_tf1_lstm_model

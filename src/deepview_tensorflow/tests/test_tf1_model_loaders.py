...
from deepview.base import Model, pipeline, ResponseInfo
from deepview.samples import StubImageDataset
from deepview.processors import FieldRenamer
from deepview_tensorflow import load_tf_model_from_memory
from deepview_tensorflow.samples import get_simple_cnn_model
from deepview_tensorflow._tensorflow._tf1_model import _Tensorflow1ModelDetails
from deepview_tensorflow._tensorflow._tf1_loading import (
    _TF1LoadingChain,
)

from deepview_tensorflow._tensorflow._tf1_file_loaders import (
...
from deepview_tensorflow._tensorflow._tensorflow_file_loaders import _TFLoader, _clear_keras_session
...
def _test_loading(model_path: pathlib.Path) -> t.Type[_TFLoader]:
    ...
    # load saved model using DeepView TF saved model loader

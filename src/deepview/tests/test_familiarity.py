...
from deepview.introspectors._familiarity._gaussian_familiarity import (
    _MixtureOfMultivariateGaussianDistributions
)
from deepview.base import Producer, pipeline
from deepview.introspectors import Familiarity, GMMCovarianceType

from deepview.samples import StubProducer
...
def test_gmm_familiarity_scores(gaussian_count: int, number_new_samples: int,
    ...
    # Fit sklearn GMM and compare with DeepView fitted GMM
    sklearn_gm = {}
    ...
    # Compare sk and deepview familiarity evaluation on new data
    ...
    # Compare sk and deepview ranking
    ...
    for response_name in stub_data.keys():
        ...
        assert [v[0] for v in deepview_sorted_scores] == [v[0] for v in sk_sorted_scores]

...
data_files_spec = [
    ('share/jupyter/nbextensions/canvas_familiarity',
     'canvas_familiarity/nbextension', '**'),
    ('share/jupyter/labextensions/canvas-familiarity',
     'canvas_familiarity/labextension', '**'),
    ('share/jupyter/labextensions/canvas-familiarity',
     '.', 'install.json'),
    ('etc/jupyter/nbconfig/notebook.d', '.',
     'canvas_familiarity.json'),
]

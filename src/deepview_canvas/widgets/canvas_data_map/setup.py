...
data_files_spec = [
    ('share/jupyter/nbextensions/canvas_data_map',
     'canvas_data_map/nbextension', '**'),
    ('share/jupyter/labextensions/canvas-data-map',
     'canvas_data_map/labextension', '**'),
    ('share/jupyter/labextensions/canvas-data-map',
     '.', 'install.json'),
    ('etc/jupyter/nbconfig/notebook.d', '.',
     'canvas_data_map.json'),
]

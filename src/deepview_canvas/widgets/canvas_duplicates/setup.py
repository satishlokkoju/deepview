...
data_files_spec = [
    ('share/jupyter/nbextensions/canvas_duplicates',
     'canvas_duplicates/nbextension', '**'),
    ('share/jupyter/labextensions/canvas-duplicates',
     'canvas_duplicates/labextension', '**'),
    ('share/jupyter/labextensions/canvas-duplicates',
     '.', 'install.json'),
    ('etc/jupyter/nbconfig/notebook.d', '.',
     'canvas_duplicates.json'),
]
